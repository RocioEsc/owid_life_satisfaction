...
“Share of people who respond they are "very happy" or "rather happy" to the question "Talking all things together, would you say you are...”
...
happy_chart <- 
  happy %>% 
  filter(Country %in% c("Switzerland", "Guatemala", "Australia", "Zimbabwe", "Japan")) %>%
...
function filter_default() {
  var default_countries = ["Switzerland", "Guatemala", "Australia", "Zimbabwe", "Japan"]; // Set default countries here
